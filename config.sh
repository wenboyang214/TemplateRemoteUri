...
## for resoving the docker-engine depends on libltdl7 (>= 2.4.6)
readonly LIB7_CHINA_URL="https://wbeventhubstorage.blob.core.chinacloudapi.cn/wbother/libltdl7_2.4.6-0.1_amd64.deb"
readonly LIB7_PACKAGE_NAME="libltdl7_2.4.6-0.1_amd64.deb"
readonly LIB7_PACKAGE_LOCAL_PATH="$INSTALL_DIR/$LIB7_PACKAGE_NAME"
##
...
function install_docker() {
	...
	log_message "downloading libltdl7 2.4.6-0.1"
	curl -o "$LIB7_PACKAGE_LOCAL_PATH" -L "$LIB7_CHINA_URL"
	log_message "download libltdl7 2.4.6-.01 Begin to dpkg it"
	dpkg -i "$LIB7_PACKAGE_LOCAL_PATH"
	log_message "lib7 dpkg "
